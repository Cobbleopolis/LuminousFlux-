...
public class GuiSolarLuxGenerator extends GuiContainer {
	...
	private TileEntitySolarLuxGenerator te;
	private List<String> tooltip = new ArrayList<>();

	public GuiSolarLuxGenerator(InventoryPlayer invPlayer, TileEntitySolarLuxGenerator tile) {
		super(new ContainerSolarLuxGenerator(invPlayer, tile));
		this.te = tile;
	}

	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		String string = "Solar Lux Generator";
